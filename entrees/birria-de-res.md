...
1. Add the meat and vigorously simmer until the meat falls off the bone.
1. Shred the meat and cut it so you don't have any long strands of meat.
1. Filter the consomé (broth) through a fine mesh sieve and chill overnight in the fridge.
1. Once chilled, remove the fat (set aside if you're making [quesabirria](quesabirria.md)), heat the consomé, and serve.
1. Garnish with cilantro, diced white onions, and radish, to taste.
